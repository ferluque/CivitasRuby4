...
#    /
    def aplicar_a_jugador (actual, todos)
      puts "Error, llamando a Sorpresa::aplicar_a_jugador con una sorpresa generica"
...
#      sorpresas.push(self.new_otros(Civitas::Tipo_sorpresa::PORCASAHOTEL, 10, "El jugador paga 10 por casahotel"))
